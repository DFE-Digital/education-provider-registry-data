...
$lines = @(
    ...
    "",
    "**This page is not a complete inventory of current GIAS Details-tab fields.** The SHACL shapes model selected structural constraints for accountability relationships, provision classifications, SEN context, and faith context. Many fields visible in the current GIAS Details tab — address, contact details, pupil numbers, Ofsted links, open and close dates — are not constrained in the SHACL and do not appear here.",
    "",
